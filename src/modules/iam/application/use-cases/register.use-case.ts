...
export class RegisterUseCase {
  constructor(
    ...
    @Inject(IAM_TOKENS.USER_ROLE_REPOSITORY) private readonly userRoleRepo: IUserRoleRepository,
    @Inject(IAM_TOKENS.PASSWORD_HASHER) private readonly passwordHasher: PasswordHasherPort,
  ...
  async execute(input: RegisterCommand): Promise<RegisterResponse> {
    return await this.dataSource.transaction(async (manager) => {
      ...
      const clientRole = await roleOrmRepo.findOne({
